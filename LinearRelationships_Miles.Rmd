...
linear_rsquared <- data.frame(Buffer, NDSI_Imperv_lm, NDSI_Connect_lm, NDSI_Structure_lm, ANT_Imperv_lm, ANT_Connect_lm, ANT_Structure_lm, BIO_Imperv_lm, BIO_Connect_lm, BIO_Structure_lm )



# write.csv(linear_rsquared, file = "linear_rsquared.csv")
...
RSquaredPlot_NDSI <- ggplot(data = linear_rsquared) +
  ...
  geom_line(aes(x = linear_rsquared$Buffer, y = linear_rsquared$NDSI_Connect_lm, color = 'Connect')) + scale_x_log10() + 
...
RSquaredPlot_ANT <- ggplot(data = linear_rsquared) +
  ...
  geom_line(aes(x = linear_rsquared$Buffer, y = linear_rsquared$ANT_Connect_lm, color = 'Connect')) + scale_x_log10() + 
...
RSquaredPlot_Bio <- ggplot(data = linear_rsquared) +
  ...
  geom_line(aes(x = linear_rsquared$Buffer, y = linear_rsquared$BIO_Connect_lm, color = 'Connect')) + scale_x_log10() + 
