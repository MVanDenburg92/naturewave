...
#import connectedness raster file
traffic <- raster("~/Spatial_Analysis_R/naturewave/Amherst_CAPS2011/traffic/traffic.tif", crs = crs(sample_points_f))
plot(traffic)
...
metric_traffic <- scale_sample(landscape = traffic_cropped, y = samp_matrix, shape = "circle", size = 500, max_size = 3000, level = "landscape", what = "lsm_l_area_mn", verbose = TRUE, progress = TRUE)
