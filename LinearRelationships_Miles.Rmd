...
setwd(dir = "../naturewave/extdata/data/")
...
setwd("../naturewave/extdata/data/sample_sites/")
sample_points_f <- st_read("sample_sites_projected.shp")
...
imperv <- raster("../naturewave/extdata/data/Amherst_CAPS2011/imperv/imperv.tif", crs = crs(sample_points_f))
plot(imperv)
...
connect <- raster("../naturewave/extdata/data/Amherst_CAPS2011/connect/connect.tif", crs = crs(sample_points_f))
plot(connect)
plot(sample_points_f, col = "red", add = TRUE)
plot(AOI, add = TRUE)
st_crs(connect)
...
structure <- raster("../naturewave/extdata/data/Amherst_CAPS2011/structure/structure.tif", crs = crs(sample_points_f))
plot(structure)
plot(sample_points_f, col = "red", add = TRUE)
plot(AOI, add = TRUE)
st_crs(structure)
...
#import connectedness raster file
traffic <- raster("../naturewave/extdata/data/Amherst_CAPS2011/traffic/traffic.tif", crs = crs(sample_points_f))
plot(traffic)
