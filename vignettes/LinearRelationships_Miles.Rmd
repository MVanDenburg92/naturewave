...
## Calculate focal mean stat at a weight of 3000 for each variable of interest
...
Code to extract values from a Raster* object at the locations of other spatial data. You can use coordinates
(points), lines, polygons or an Extent (rectangle) object.
