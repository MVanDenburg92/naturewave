...
# fw_sum_2000[[3]]
# 
# as.matrix(fw_sum_2000[[1]])


radius <- 2000
lc2000 <- lapply(1:4, function(x) {  # x <- 1
  f <- paste0("../external/data/Amherst_CAPS2011", names(lc_stack)[x], "____", radius, ".tif")
  r <- focal(lc_stack[[x]], w = as.matrix(fw_sum_2000[[x]]), filename = f)
  return(r)
})
...
pts4 <- cbind(pts1, raster::extract(lc2000_stacked, pts1))  # buffer points
