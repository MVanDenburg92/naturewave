...
plot(imperv_cropped__focal_mean_fixed, main ="Circular MW Mean with function speficied")
...
plot(imperv_cropped__focal_mean_fixed, main ="Circular MW Mean with function speficied", ext = extent(buff500_firstsite))
buffs_extract[[1]]$sites %>% plot(col = NA, add=TRUE, border = "red")
...
plot(imperv_cropped__focal_mean_fixed, main ="Circular MW Mean with function speficied", ext = extent(buff3000_secondsite))
