...
writeRaster(lc2500_stacked[[1]], filename = "lc2500_connect.tif", overwrite = TRUE)
writeRaster(lc2500_stacked[[2]], filename = "lc2500_imperv.tif", overwrite = TRUE)
writeRaster(lc2500_stacked[[3]], filename = "lc2500_structure.tif", overwrite = TRUE)
writeRaster(lc2500_stacked[[4]], filename = "lc2500_traffic.tif", overwrite = TRUE)
