...
zonal <- raster::extract(imperv_cropped, sample_points_f, fun= mean, buffer = x, na.rm=TRUE)
})
...
zonal <- raster::extract(connect_cropped, sample_points_f, fun= mean, buffer = x, na.rm=TRUE)
})
...
zonal <- raster::extract(structure_cropped, sample_points_f, fun= mean, buffer = x, na.rm=TRUE)
})
...
zonal <- raster::extract(traffic_cropped, sample_points_f, fun= mean, buffer = x, na.rm=TRUE)
})
...
write.csv(Imperv_connect_Struct_Traffic_NDSI, file.path(path_out, "Imperv_connect_Struct_Traffic_NDSI.csv"), row.names = FALSE)
...
cor(x = Imperv_connect_Struct_Traffic_NDSI$NDSI, y = Imperv_connect_Struct_Traffic_NDSI$Imperv)
...
lm_NDSI_Connect <- lmList(NDSI ~ Connectdness | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
NDSI_Connect_lm <-summary(lm_NDSI_Connect)$r.squared

cor(x = Imperv_connect_Struct_Traffic_NDSI$NDSI, y = Imperv_connect_Struct_Traffic_NDSI$Connectdness)
...
lm_NDSI_Structure <- lmList(NDSI ~ Structure | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
NDSI_Structure_lm <-summary(lm_NDSI_Structure)$r.squared

cor(x = Imperv_connect_Struct_Traffic_NDSI$NDSI, y = Imperv_connect_Struct_Traffic_NDSI$Structure)
...
lm_ANT_Imperv <- lmList(Anthrophony ~ Imperv | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
ANT_Imperv_lm <- summary(lm_ANT_Imperv)$r.squared


cor(x = Imperv_connect_Struct_Traffic_NDSI$Anthrophony, y = Imperv_connect_Struct_Traffic_NDSI$Imperv)
...
lm_ANT_Connect <- lmList(Anthrophony ~ Connectdness | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
ANT_Connect_lm <-summary(lm_ANT_Connect)$r.squared

cor(x = Imperv_connect_Struct_Traffic_NDSI$Anthrophony, y = Imperv_connect_Struct_Traffic_NDSI$Connectdness)
...
lm_ANT_Structure <- lmList(Anthrophony ~ Structure | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
ANT_Structure_lm <-summary(lm_ANT_Structure)$r.squared

cor(x = Imperv_connect_Struct_Traffic_NDSI$Anthrophony, y = Imperv_connect_Struct_Traffic_NDSI$Structure)
...
lm_BIO_Imperv <- lmList(Biophony ~ Imperv | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
BIO_Imperv_lm <- summary(lm_BIO_Imperv)$r.squared

lm_BIO_Imperv
BIO_Imperv_lm

cor(x = Imperv_connect_Struct_Traffic_NDSI$Biophony, y = Imperv_connect_Struct_Traffic_NDSI$Imperv)
...
lm_BIO_Connect <- lmList(Biophony ~ Connectdness | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
BIO_Connect_lm <-summary(lm_BIO_Connect)$r.squared

cor(x = Imperv_connect_Struct_Traffic_NDSI$Biophony, y = Imperv_connect_Struct_Traffic_NDSI$Connectdness)
...
lm_BIO_Structure <- lmList(Biophony ~ Structure | Buffer, data = Imperv_connect_Struct_Traffic_NDSI, pool = FALSE)
BIO_Structure_lm <-summary(lm_BIO_Structure)$r.squared

cor(x = Imperv_connect_Struct_Traffic_NDSI$Biophony, y = Imperv_connect_Struct_Traffic_NDSI$Structure)
...
## ----include=FALSE, warning = FALSE, message = FALSE, eval = FALSE------------
#  
